...
let ContactsAdmin = () => {
    ...
    let contactState = useSelector((store) => {
        return store[contactReducer.CONTACTS_FEATURE];
    });

    let [query, setQuery] = useState("");
    let [localContacts, setLocalContacts] = useState([]);
    ...
    let {loading, contactList, errorMessage, filteredContactList} = contactState;
